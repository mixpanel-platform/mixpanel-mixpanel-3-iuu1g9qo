function overallRetentionQuery (){
  ...
  console.log('retention restsults \n', results);
  //tranform the jql result so it can be graphed into a highcharts chart
  var graphData = transformDataforOverallRetention(results)
  //console.log("transformed data /n", graphData);
  //graph highcharts chart
  graphLineChart("overall-retention", "Unbounded Retention for <b>"+params.correlationEvent+"</b>", "Percet of User Retained", "Day's Retained" ,"%",graphData)
  })
}
